"""Helpers to install and uninstall a Linux desktop entry for VARS Localize."""
...
APP_ID = "vars-localize"
APP_NAME = "VARS Localize"
APP_COMMENT = "Create and edit observation localizations in VARS"
ICONSET_REL_PATH = Path("icons") / "VARSLocalize.iconset"
...
def install_desktop_entry() -> int:
    ...
    for size in ICON_SIZES:
        source_icon = get_asset_path(ICONSET_REL_PATH / f"icon_{size}.png")
